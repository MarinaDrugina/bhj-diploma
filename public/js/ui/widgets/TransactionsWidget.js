...
class TransactionsWidget {
  ...
  registerEvents() {
    ...
    createIncomeBtn.addEventListener('click', (event) => {
        return App.getModal('#modal-new-income').open();
    });
    
    createExpenseBtn.addEventListener('click', (event) => {
        return App.getModal('#modal-new-expense').open();
    });
  }
}
